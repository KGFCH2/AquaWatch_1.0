...
const statesData: StateData[] = [
  ...
  },
  {
    ...
    population: "1.1M",
    mainIssues: [
      "Dependency on neighboring states",
      "Groundwater depletion",
      "Urban stress",
    ],
    trend: "stable",
    ...
    case "up":
      return (
        <TrendingUp
          ...
          aria-label="Water levels improving"
        />
      );
    case "down":
      return (
        <TrendingDown
          ...
          aria-label="Water levels declining"
        />
      );
    case "stable":
      return (
        <Minus
          ...
          aria-label="Water levels stable"
        />
      );
    default:
      return null;
