...
export const CrisisOverview: React.FC = () => {
  return (
    <section className="mb-8" aria-labelledby="crisis-overview-title">
      <div className="mb-6">
        <h2 id="crisis-overview-title" className="text-3xl font-bold text-gray-900 mb-2">
          National Water Crisis Overview
        </h2>
        <p className="text-gray-600 max-w-3xl">
          Real-time monitoring of India's water crisis situation across all states and union territories. 
          Critical data updated every 6 hours from government and satellite sources.
        </p>
      </div>
        ...
        {stats.map((stat, index) => {
          ...
          return (
            ...
            >
              ...
              <h3 id={`stat-${index}-title`} className="font-semibold text-gray-900 mb-1">
                {stat.title}
              </h3>
      ...
      <div className="bg-gradient-to-r from-red-50 to-orange-50 border-l-4 border-red-400 rounded-lg p-6">
        <div className="flex items-start">
          <AlertTriangle className="h-6 w-6 text-red-400 mt-1 mr-3 flex-shrink-0" aria-hidden="true" />
          <div>
            <h3 className="text-lg font-semibold text-red-800 mb-2">Critical Alert</h3>
            <p className="text-red-700 mb-3">
              Chennai, Bengaluru, Delhi, and Lakshadweep are experiencing severe water stress. Immediate intervention required.
            </p>
            <button 
