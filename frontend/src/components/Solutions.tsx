...
import { Lightbulb, Droplets, Recycle, Zap, Users, ArrowRight } from 'lucide-react';
...
const solutions: Solution[] = [
  {
    ...
    description: 'Implement rooftop and community-level rainwater collection and storage systems',
    category: 'immediate',
    icon: Droplets,
    impact: 'High',
  ...
  },
  {
    ...
    description: 'Treat and reuse household wastewater for irrigation and non-potable uses',
    category: 'short-term',
    icon: Recycle,
    impact: 'Medium',
  ...
  },
  {
    ...
    description: 'Establish local water user associations for sustainable resource management',
    category: 'immediate',
    icon: Users,
    impact: 'High',
    cost: '₹1,000 - ₹10,000',
  ...
  },
  {
    ...
    description: 'Replace flood irrigation with drip and sprinkler systems to reduce water waste',
    category: 'short-term',
    icon: Droplets,
    impact: 'High',
  ...
  },
  {
    ...
    description: 'Enhance natural groundwater replenishment through artificial recharge structures',
    category: 'long-term',
    icon: Lightbulb,
    impact: 'Very High',
...
export const Solutions: React.FC = () => {
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      ...
      case 'short-term': return 'bg-yellow-100 text-yellow-800 border-yellow-200';
  ...
  return (
    <section aria-labelledby="solutions-title">
      <div className="mb-8">
        <h2 id="solutions-title" className="text-3xl font-bold text-gray-900 mb-4">
          Water Crisis Recovery Solutions
        </h2>
        <p className="text-gray-600 max-w-4xl">
          Comprehensive solutions for addressing India's water crisis at individual, community, and state levels. 
          Each solution includes implementation steps, cost estimates, and real-world examples.
        </p>
      </div>
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full border ${getCategoryColor(solution.category)} mt-1`}>
                ...
                <div className="grid grid-cols-3 gap-4 mb-4 text-sm">
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{solution.impact}</p>
                  </div>
                  <div>
                ...
                <button
                  ...
                  aria-label={`${isExpanded ? 'Collapse' : 'Expand'} details for ${solution.title}`}
                >
                  <span>{isExpanded ? 'Hide Details' : 'View Details'}</span>
                  <ArrowRight className={`h-4 w-4 transition-transform duration-200 ${isExpanded ? 'rotate-90' : ''}`} aria-hidden="true" />
                </button>
              </div>
              ...
              {isExpanded && (
                <div className="px-6 pb-6 border-t border-gray-100 pt-6">
                  <div className="space-y-6">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-3">Success Examples</h4>
      ...
      <div className="mt-12 bg-gradient-to-r from-red-50 to-orange-50 border border-red-200 rounded-xl p-6">
        <h3 className="text-xl font-semibold text-red-800 mb-4">Need Immediate Help?</h3>
